...
parser.add_argument('--adj-type', type=str, default='appr')
...
class Net(torch.nn.Module):
    def __init__(self, dataset):
        ...
        self.conv1 = DIGCNConv(dataset.num_features, args.hidden)
        self.conv2 = DIGCNConv(args.hidden, dataset.num_classes)
